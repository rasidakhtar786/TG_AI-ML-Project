...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        Read data from MongoDB in Dataframe       
    ...
    def split_data_as_train_test(self,dataframe : pd.DataFrame):
        try:
            ...
            logging.info("Peformed train test split on the dataframe")
            logging.info("Exited split_data_as_train_test method of Data_Igestion class")
